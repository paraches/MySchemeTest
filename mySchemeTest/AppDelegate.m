...
@interface NSURL (YKCategory)
-(NSDictionary *)queryAsDictionary;
@end

@implementation NSURL (YKCategory)
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	NSString *nameString = [[query objectForKey:@"name"] stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
	NSString *urlString = [query objectForKey:@"url"];
	self.viewController.nameLabel.text = nameString;
	self.viewController.urlLabel.text = urlString;
